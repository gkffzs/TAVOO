...
// -------------------------------------------------------------------------------------------------
// This activity is responsible for displaying the basic info about the application, such as its ---
// version, its purpose, etc. ----------------------------------------------------------------------
// -------------------------------------------------------------------------------------------------
public class AboutActivity extends Activity { // ---------------------------------------------------
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = PreferenceManager.getDefaultSharedPreferences(AboutActivity.this);
        loggedInUserID = sharedPreferences.getInt("user_id", 0);
        activityTag = getString(R.string.activ_about_tag);
