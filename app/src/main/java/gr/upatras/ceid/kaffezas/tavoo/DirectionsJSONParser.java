...
// -------------------------------------------------------------------------------------------------
// This class is used to parse the data that come in JSON format and are used for directions on ----
// the Google map. It parses the response and decodes the resulted polyline. The source code of ----
// decodePolyline() is based on the source code that was written by Jeffrey Sambells for decoding --
// polylines from Google Directions API. It can be found in the following link: --------------------
...
public class DirectionsJSONParser { // -------------------------------------------------------------
    ...
    public List<List<HashMap<String, String>>> parseFeed(JSONObject jObject) {
